...
<div id="sidebar">
  <div class="nav-elements">
    ...
    <a href="index.php" class="link">
      <h1 class="logo">
        <span style="color:#25CDEA;">binge</span><span style="color:#15EBCD;font-weight:300;">room.</span>
      </h1>
    </a>
    ...
    <div class="links_wrap">
      ...
      <a class="sb_link filter" href="javascript:void(0);" id="movies" data-filter=".category-2"><i class="fa fa-film" aria-hidden="true"></i> &nbsp;Shorts</a>
      <a class="sb_link filter" href="javascript:void(0);" id="series" data-filter=".category-1"><i class="fa fa-tv" aria-hidden="true"></i> &nbsp;Series</a>
      <!--<a class="sb_link filter" href="javascript:void(0);" id="language-1" data-filter=".lang-1"><i class="fa fa-tv" aria-hidden="true"></i> &nbsp;English</a>
      <a class="sb_link filter" href="javascript:void(0);" id="language-2" data-filter=".lang-2"><i class="fa fa-tv" aria-hidden="true"></i> &nbsp;Hindi</a>-->
      <div class="lang-select-block">
        <div class="lang-select-title">Watch In</div>
        <div class="select-blk">
          <div class="lang-select" id="langauge-1" data-filter=".lang-1">ENG</div>
          <div class="lang-select" id="langauge-2" data-filter=".lang-2">HIN</div>
        </div>
      </div>
...
<div id="content">
  ...
  <?php
              ...
              echo '            <div class="media_grid">
                ...
                {
                  echo '
                        <div class="col span_1_of_6 mix category-'.$row['md_type'].' lang-'.$row['md_lang'].'" data-byname="'.$name_id.'" data-bytype="'.$row['md_type'].'" data-byrating="'.$row['md_rating'].'" data-bytime="'.$row['mid'].'" data-byyear="'.$row['md_year'].'">
              ...
              while($row = mysqli_fetch_array($result))
              {
                echo '<div class="md-modal md-effect-3" id="modal-'.$row['mid'].'">
                        ...
                        <div class="media_modal_info">
                          ...
                          <button href="#" class="media_button blue_bg" id="media_icon_more">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                            <span class="hide_on_mobile"> &nbsp;KNOW MORE</span>
                          </button>
